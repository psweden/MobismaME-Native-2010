...
public class HelpInfo extends Canvas {
    ...
    protected void paint(Graphics g){
        ...
        imageGraphics.setColor(0xffff00);
        imageGraphics.drawString("Support", width/2, 100, Graphics.TOP | Graphics.HCENTER);

        imageGraphics.setColor(0xffffff);
        imageGraphics.drawString("www.mobisma.com", width/2, 120, Graphics.TOP | Graphics.HCENTER);
        imageGraphics.drawString("support@mobisma.com", width/2, 140, Graphics.TOP | Graphics.HCENTER);
